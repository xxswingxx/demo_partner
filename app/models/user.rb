class User < ActiveRecord::Base
  ...
  def create_quaderno_account
    ...
    response = HTTParty.post('http://lvh.me:3000/partners/api/v1/accounts.json', body: account_attributes, basic_auth: { username: Rails.application.secrets.quaderno_secret }).parsed_response.symbolize_keys
