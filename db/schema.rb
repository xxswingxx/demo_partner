...
ActiveRecord::Schema.define(version: 20150105141323) do
  ...
  add_index "users", ["quaderno_account_id"], name: "index_users_on_quaderno_account_id", using: :btree
  add_index "users", ["quaderno_id"], name: "index_users_on_quaderno_id", using: :btree
